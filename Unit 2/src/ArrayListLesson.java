        ...
        while (true) {
            ...
            if (user_input == 1) {
                ...
                if (pos < 0 || pos > emparr.size() - 1) {
                    ...
                    System.out.println("Employee " + emparr.get(pos).getEmployeeID() + ": " + emparr.get(pos).getFirstName() +
                            " " + emparr.get(pos).getLastName() + " is currently earning $" + emparr.get(pos).getSalary());
                }
            }
        }
    }
